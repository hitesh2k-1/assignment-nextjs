...
const CourseCurriculum = () => {
  ...
  return (
    <div className="max-w-[90vw] lg:max-w-[70vw] mx-auto p-6">
      <h1 className="sm:text-6xl text-3xl font-bold sm:font-semibold text-center gradient-text mb-4">Course Curriculum</h1>
      <p className="text-center sm:text-lg m-auto mb-8 max-w-[90vw] sm:max-w-[50vw] text-gray-700">
      ...
      <div className="grid grid-cols-1 text-xl sm:text-2xl text-gray-700 sm:grid-cols-2 md:grid-cols-3 gap-6">
