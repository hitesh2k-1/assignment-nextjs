        ...
        <div className="bg-gray-50 py-10 my-10">
            ...
            <div className="text-center mb-10">
                ...
                <p className="mt-4 text-lg text-gray-600 max-w-[50vw] m-auto">
                    Get into the mind of India's top social media strategist and steal his secrets that have helped him close marquee brands as Clients.
                </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center mt-2 space-x-4">
                <img src="/images/afaqs.png" alt="Afaqs" />
                <img src="/images/campaign.png" alt="Campaign India"  />
                <img src="/images/brandequity.png" alt="Brand Equity"  />
                <img src="/images/adgully.png" alt="Adgully" />
            </div>
        </div>
    );
};
