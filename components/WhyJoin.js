...
const WhyJoinCourse = () => {
  return (
    <div>
    <div className="bg-gradient-to-r from-[#5A54A8] to-[#C81151] text-white py-12 px-6 h-[70vh]">
      <h2 className="text-5xl font-semibold text-center my-16">Why join this course? 🚀</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[70vw] m-auto ">
        {/* Card 1 */}
        <div className="flex items-center space-x-4 px-6 max-w-[20vw] rounded-2xl py-4 border-2 bg-white text-gray-700 ">
 ...
 In-depth course
  ...
  <span className="font-bold">Lifetime Access</span>  to course lessons
    ...
    <div className="py-16 max-w-[45vw] m-auto  bg-gray-50 flex justify-center flex-col ">
